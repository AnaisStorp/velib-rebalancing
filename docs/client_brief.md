...
- **Dockout-minutes per station per day**: total minutes a station sits at 0 free docks.
  Together these are our **"failure-minutes"** north star. Successful rebalancing keeps
  high-traffic stations supplied without causing truck mileage to rise excessively.
...
**Out of scope (marked for a possible follow-on):**
